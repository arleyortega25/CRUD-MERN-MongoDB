...
function TaskCard(props) {
  ...
  return (
    <div className="bg-white shadow-md rounded-xl p-6 mb-4 w-full max-w-md mx-auto">
      <h1 className="text-xl font-semibold text-gray-800 mb-2">{props.task.titulo}</h1>
      ...
      <p className="text-sm text-gray-400">{new Date(props.task.fecha).toLocaleDateString()}</p>
    </div>
  );
}
