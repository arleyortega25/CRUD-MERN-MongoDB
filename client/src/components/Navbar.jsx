  ...
  return (
    <div className="bg-zinc-800 text-neutral-400   ">
      <ul className="flex justify-between my-3 mx-2 py-3">
        <li>
          <Link to={"/"} className="text-2xl font-bold hover:text-white">YourTask.com</Link>
        </li>
        {isAuthenticated ? (
          <>
            <li>
            ...
            <div className="flex justify-between mx-3 px-3  ">
                ...
                <li>
                  <button onClick={LogOut} className="bg-red-500 text-black rounded-xl text-2xs p-1 mx-3">cerrar Sesion </button>
                </li>
            </div>
          </>
        ) : (
